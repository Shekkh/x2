...
**-- -- -- -- -- -- -- -- --
 ...
 -- -- -- -- - 
 سداسي 
 ssssxx { سداسي حرفين عشوائي قديم }
 سداسي1
 sssxxx { سداسي 3 حروف عشوائي قديم }
 سداسي2
 sss888 { سداسي 3 حروف مرتب }
 سداسي3
sssxxx { سداسي 3 حروف عشوائي }
سداسي4
sxxxxs { سداسي حرفين مرتب }
سداسي5
ssxxxx { سداسي حرفين عشوائي }
سداسي6
saaaaa { سداسي حرف عشوائي }
سداسي7
sssxxx { سداسي 3 حروف قديم - حروف }
سداسي8
ssssxx { سداسي حرفين قديم - حروف }
   -- -- -- -- -- 
        ...
        try:
            ch = await eighthon(
                functions.channels.CreateChannelRequest(
                    title="صيد معرفات سداسي حرفين - Hunting IDs",
                    about="تم الصيد يوزر سداسي حرفين - ID caught",
                )
            )
